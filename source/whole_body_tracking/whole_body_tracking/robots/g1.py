...
UNITREE_G1_URDF = os.environ.get(
    "UNITREE_G1_URDF",
    "/root/unitree_rl_gym-main/resources/robots/g1_description/g1_29dof.urdf",
)
if not os.path.isfile(UNITREE_G1_URDF):
    UNITREE_G1_URDF = f"{ASSET_DIR}/unitree_description/urdf/g1/main.urdf"
