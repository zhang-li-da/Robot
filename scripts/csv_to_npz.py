...
parser.add_argument("--output_file", type=str, default="/tmp/motion.npz", help="Local output motion.npz path.")
parser.add_argument("--no_wandb", action="store_true", default=False, help="Save locally and skip WandB upload.")
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene, joint_names: list[str]):
    ...
    while simulation_app.is_running():
        ...
        if reset_flag and not file_saved:
            ...
            REGISTRY = "motions"
            logged_artifact = run.log_artifact(artifact_or_path=args_cli.output_file, name=COLLECTION, type=REGISTRY)
